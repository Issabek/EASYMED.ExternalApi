...
namespace EASYMED.ExternalApi.Controllers
{
    ...
    public class QRSignController : ControllerBase
    {
        ...
        [Route("QRReceipt/GetQR")]
        [HttpGet]
        public async Task<string> GetQR(string encodeString)
        {
            Byte[] byteArray;
            ...
            var pixelData = qrCodeWriter.Write(encodeString);
            ...
            using (var bitmap = new System.Drawing.Bitmap(pixelData.Width, pixelData.Height, System.Drawing.Imaging.PixelFormat.Format32bppRgb))
            {
                ...
                return "<img src=\"" + String.Format("data:image/png;base64,{0}", Convert.ToBase64String(byteArray)) + "\"/>";
            }
        }        
